...
**近 18 个月最重要的变化**：**推理模型（Reasoning Models）成为行业共识**。从 2024 年 9 月 OpenAI `o1` 首发，到 2025 年 DeepSeek R1 开源、Claude 4 系列将 extended thinking 内建、Gemini 2.5 Pro 全系带 thinking——**所有头部模型都已经是"可显式思考 + 可工具调用"的 Agent 底座**。详见 [推理模型专题](推理模型专题.md)。
...
**"六小虎 + 三大厂"**（详见 [中国 AI 梯队结构](中国AI梯队结构.md)）：
...
格局清晰：**Cursor（Anysphere）** 在开发者中占据头部，**Claude Code**（Anthropic）、**Windsurf**、**GitHub Copilot**、**字节 Trae** 紧追。详见 [AI Coding 产品格局](../../05_AI互联网/01_行业研究/AI_Coding产品格局.md)。
...
- 详见 [生成式搜索革命](../../05_AI互联网/01_行业研究/生成式搜索革命.md)
...
### 3. 中美技术管制
- 美国对中国：GPU 出口、EDA 工具、HBM 设备（详见 [AI 训练基础设施 GPU 供需与云厂商格局](AI训练基础设施.md)）
...
**同板块深度文章**：
- [大模型技术路线对比：Dense / MoE / Reasoning](大模型路线对比.md)
- [推理模型专题：从 o1 到 R1 到 Claude Sonnet 4.6](推理模型专题.md)
- [AI 训练基础设施：GPU 供需与云厂商格局](AI训练基础设施.md)
- [AI Agent 行业现状与路线分歧](Agent行业现状.md)
- [中国 AI 梯队结构](中国AI梯队结构.md)

**公司级深挖**：
- [Anthropic](../02_公司研究/Anthropic.md) · [OpenAI](../02_公司研究/OpenAI.md) · [Google DeepMind](../02_公司研究/Google_DeepMind.md)
- [DeepSeek](../02_公司研究/DeepSeek.md) · [Moonshot 月之暗面](../02_公司研究/Moonshot.md)
