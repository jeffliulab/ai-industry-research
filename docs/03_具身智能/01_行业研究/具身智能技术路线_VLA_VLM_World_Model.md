...
> 最后更新：2026-04-22
>
> 本文是**具身智能板块**入口总览。具身智能（Embodied AI）是**机器人能不能真正"活在物理世界里"的大脑问题**。硬件视角见 [人形机器人行业格局](../../02_机器人/01_行业研究/人形机器人行业格局2026.md)，本文聚焦**算法路线**与**产业玩家**。
...
**产业共识**：单一数据源都不够——**真机 + 仿真 + 视频预训练**混合是标配。详见 [Sim2Real 与仿真平台](Sim2Real与仿真平台_Isaac_MuJoCo_Genesis.md)。
...
详见：[Physical Intelligence](../02_公司调研/Physical_Intelligence_π.md) · [Skild AI](../02_公司调研/Skild_AI.md) · [Covariant](../02_公司调研/Covariant.md) · [Wayve](../02_公司调研/Wayve.md)
...
**同板块深度**：
- [Sim2Real 与仿真平台：Isaac / MuJoCo / Genesis](Sim2Real与仿真平台_Isaac_MuJoCo_Genesis.md)
- [具身智能数据采集：遥操作 / 仿真 / 真机](具身智能数据采集_遥操作_仿真_真机.md)
- [具身智能评测基准](具身智能评测基准.md)
- [具身基础模型的 Scaling Law 讨论](具身基础模型的Scaling_Law讨论.md)

**公司级**：
- [Physical Intelligence (π)](../02_公司调研/Physical_Intelligence_π.md) · [Skild AI](../02_公司调研/Skild_AI.md)
- [Covariant](../02_公司调研/Covariant.md) · [Wayve](../02_公司调研/Wayve.md)
- [银河通用 Galbot](../02_公司调研/银河通用_Galbot.md)

**产品 / 模型**：
- [π0 与 π0.5](../03_产品调研/π0_与_π0_5.md) · [Helix (Figure)](../03_产品调研/Helix_Figure.md)
- [GR00T (NVIDIA)](../03_产品调研/GR00T_NVIDIA.md) · [RT-2 / OpenVLA](../03_产品调研/RT2_OpenVLA.md)

**交叉**：
- [人形机器人行业格局 2026](../../02_机器人/01_行业研究/人形机器人行业格局2026.md) —— 从硬件角度看同一产业
